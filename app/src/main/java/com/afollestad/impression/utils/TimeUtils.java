...
public class TimeUtils {
     ...
     */
    private static String toString(Calendar date, boolean includeTime, boolean shortMonth) {
        Calendar now = Calendar.getInstance();
        int hourInt = date.get(Calendar.HOUR);
        int minuteInt = date.get(Calendar.MINUTE);
        String dayStr = getNumberWithSuffix(date.get(Calendar.DAY_OF_MONTH));
     ...
     */
    private static String toStringDate(Calendar time, boolean shortMonth, boolean alwaysIncludeYear) {
        Calendar now = Calendar.getInstance();
    ...
    private static String toStringTime(Calendar time) {
    ...
    private static String toStringShort(Calendar time) {
        Calendar now = Calendar.getInstance();
